...
class ColaboradorPolicy
{
    ...
    {
        return $user->can('view_any_colaborador');
    }
    ...
    {
        return $user->can('update_colaborador');
    }
    ...
    {
        return $user->can('delete_any_colaborador');
    }
    ...
    {
        return $user->can('force_delete_any_colaborador');
    }
    ...
    {
        return $user->can('restore_colaborador');
    }
    ...
    {
        return $user->can('restore_any_colaborador');
    }
    ...
    {
        return $user->can('replicate_colaborador');
    }
    ...
    {
        return $user->can('reorder_colaborador');
    }
}
